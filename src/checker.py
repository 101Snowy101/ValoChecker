...
""")
    ...
    def printinfo(self) -> None:
        ...
        ctypes.windll.kernel32.SetConsoleTitleW(
            f"ValoChecker {self.version}  |  Checked {self.checked}/{self.count}  |  {self.cpmtext} CPM  |  Hitrate {percent}  |  Private Rate {privatepercent}  |  Est. time: {self.esttime}  |  {self.comboname}"
        )
        os.system("cls")
        print(f"""
    {reset}
    {sys.center('https://github.com/101Snowy101/ValoChecker')}
